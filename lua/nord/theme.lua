...
theme.loadEditor = function ()
	...
	local editor = {
		...
		IncSearch         = { fg = nord.none, bg = nord.pink, style = 'reverse' },
    ...
    CursorLineNr      = { fg = nord.nord8_gui },
		...
		Search            = { fg = nord.nord1_gui, bg = nord.pink, style = 'reverse' },
...
theme.loadLSP = function ()
    ...
    local lsp = {
        ...
        LspReferenceText                     = { fg = nord.accent, bg = nord.selection }, -- used for highlighting "text" references
        LspReferenceRead                     = { fg = nord.accent, bg = nord.selection }, -- used for highlighting "read" references
        LspReferenceWrite                    = { fg = nord.accent, bg = nord.selection }, -- used for highlighting "write" references
    }
